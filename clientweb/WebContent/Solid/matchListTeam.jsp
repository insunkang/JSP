...
<body>
  ...
  <div id="portfoliowrap">
    <div class="portfolio-centered container" data-animate="id<%="a" %>fadeInDown">
      <div class="recentitems portfolio row" data-animate="fadeIn">
      	<!--  -->
        <div class="portfolio-item graphic-design">
          <div class="he-wrap tpl6">
            <img src="img/portfolio/portfolio_09.jpg" alt="ÆÀ¾Úºí·³" >
            <div class="he-view" >
            	
              <div class="bg a0">
              	<h3 id="a" class="a0" >HOME</h3>
                <h4 id="a" class="a0" >ÆÀ¸í</h4>                
              </div>
        ...
        <div class="portfolio-item graphic-design">
          <div class="he-wrap tpl6">
            ...
            <div class="he-view">
              <div class="bg a0">
                <h3 id="a" class="a1" >AWAY</h3>
                <h4 id="a" class="a1" >ÆÀ¸í</h4>
              </div>
              <!-- he bg -->
            </div>
            <!-- he view -->
      ...
      <div class="recentitems portfolio row">
      	<!--  -->
        ...
        <div class="portfolio-item web-design">VS
          <div class="he-wrap tpl6">
